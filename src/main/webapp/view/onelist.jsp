...
<script type="text/javascript">
	...
	function update_go(f) {
		f.action = "/BBS/MyController?cmd=update";
		f.submit();
	}
	function delete_go(f) {
		f.action = "/BBS/MyController?cmd=delete&cPage=${cPage}";
		f.submit();
	}
	...
	function comment_go(f) {
		...
		f.action = "/BBS/MyController?cmd=c_write";
		f.submit();
	}
	function comment_del(f) {
		f.action = "/BBS/MyController?cmd=c_delete";
		f.submit();
	}
</script>
</head>
			...
			<tbody>
				...
				<tr>
					...
					<c:choose>
						...
						<c:otherwise>
							<td><a href="/BBS/DownController?path=upload&f_name=${bvo.f_name}" target="_blank"><img  src="upload/${bvo.f_name}" style="80px"></a></td>
						</c:otherwise>
					</c:choose>
				</tr>
				<tr>
